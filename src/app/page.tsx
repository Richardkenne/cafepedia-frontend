  ...
  return (
    <main className="relative flex flex-col items-center justify-center min-h-dvh px-6">
      ...
      <div className="flex items-center gap-2.5 mb-1">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight" style={{ color: 'var(--primary)' }}>
          Cafepedia
        </h1>
      </div>
      <p className="text-base text-[var(--muted)] mb-1">
        Discover great places.
      </p>
      <p className="text-xs text-[var(--muted2)] mb-10">
      ...
      <section className="w-full max-w-md mt-16 grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div className="flex items-start gap-2.5 p-5 rounded-xl bg-[var(--surface)]">
          <span className="text-base leading-none mt-0.5">{"\uD83C\uDFAF"}</span>
          <div>
            <p className="text-sm font-semibold text-[var(--foreground)]">Cari berdasarkan suasana</p>
        ...
        <div className="flex items-start gap-2.5 p-5 rounded-xl bg-[var(--surface)]">
          <span className="text-base leading-none mt-0.5">{"\uD83E\uDD16"}</span>
          <div>
            <p className="text-sm font-semibold text-[var(--foreground)]">AI pilihkan untukmu</p>
        ...
        <div className="flex items-start gap-2.5 p-5 rounded-xl bg-[var(--surface)]">
          <span className="text-base leading-none mt-0.5">{"\uD83D\uDCCD"}</span>
          <div>
            <p className="text-sm font-semibold text-[var(--foreground)]">600+ cafe di Bandung</p>
      ...
      <footer className="w-full max-w-md mt-16 mb-6 text-center">
        <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-xs text-[var(--muted2)]">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-xs text-[var(--muted2)] mt-1">
